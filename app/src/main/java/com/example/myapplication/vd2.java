...
public class vd2 extends AppCompatActivity {
    ...
    private Button btn_bai5_raw, btn_bai5_url, btn_bai5_local;
    ...
    private void Init() {
        ...
        btn_bai5_local = (Button) this.findViewById(R.id.btn_bai5_local);
        btn_bai5_url = (Button) this.findViewById(R.id.btn_bai5_url);
        // Set the media controller buttons
        if (this.mediaController == null) {
            this.mediaController = new MediaController(vd2.this);
...
// When the video file ready for playback.
        ...
        this.btn_bai5_raw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                VideoViewUtils.playRawVideo(vd2.this, videoView_bai5, resName);
            }
        });
        this.btn_bai5_local.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String videoURL = VideoViewUtils.LOCAL_VIDEO_SAMPLE;
                VideoViewUtils.playURLVideo(vd2.this, videoView_bai5, videoURL);
            }
        });
