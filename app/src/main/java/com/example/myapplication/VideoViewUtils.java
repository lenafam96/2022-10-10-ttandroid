...
public class VideoViewUtils {
    ...
    public static final String LOCAL_VIDEO_SAMPLE ="/strorage/emulated/0/DCIM/Camera/VID_2022_10_10_150934.mp4";
    public static final String URL_VIDEO_SAMPLE  = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4";
    ...
    public static void playLocalVideo(Context context, VideoView videoView, String localPath)  {
        try {
//            Uri uri = Uri.parse(Environment.getExternalStorageState()+localPath);
            Uri uri = FileProvider.getUriForFile(context, context.getPackageName(), new File(localPath));
            Log.i(LOG_TAG, "Video URI: "+ uri);
